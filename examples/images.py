...
class StreamlitImages(object):
    ...
    def save(self):
        for name, data in self._data.items():
            Image.open(io.BytesIO(data)).save("examples/data/%s" % name)
...
st.image("examples/data/image.png", caption="examples/data/image.png", output_format="PNG")

st.header("From open")
st.image(open("examples/data/image.png", "rb").read(), caption="from read", output_format="PNG")
